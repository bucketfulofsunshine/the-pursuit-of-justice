...
END
++ ~Not yet.~ EXIT
+ ~Global("bfazodefeat","GLOBAL",1)~ + ~I confronted him, but his patron intervened. Dorn was slain before I could stop the blow.~ EXTERN bfbol bfs.bollardreturn2
+ ~Global("bfazodefeat","GLOBAL",1)~ + ~He was within my grasp, yet his patron struck first, ending Dorn's life before I could claim the killing blow.~ EXTERN bfbol bfs.bollardreturn2

CHAIN bfbol bfs.bollardreturn2
~Then justice, in part, has been meted out. That his patron killed him first attests to the danger you faced.~ 
== BFBOL ~You have earned my gratitude, <CHARNAME>. May this victory, disguised as it is, remind us that justice will always prevail.~
